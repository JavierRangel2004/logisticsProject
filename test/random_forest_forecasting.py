...
def train_random_forest(df, product_id):
    """
    ...
    print(f"Random Forest Model - Product ID: {product_id}, MAE: {mae:.2f}, RMSE: {rmse:.2f}")
...
if __name__ == "__main__":
    ...
    # Train and forecast using Random Forest
    train_random_forest(df, sample_product_id)
